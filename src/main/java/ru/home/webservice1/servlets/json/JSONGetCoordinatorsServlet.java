...
@Slf4j
@WebServlet("/api/coordinators")
public class JSONGetCoordinatorsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Coordinator> listCoordinator = coordinatorDAO.getAllCoordinator();
        final String jsonStudent = objectMapper.writeValueAsString(listCoordinator);
